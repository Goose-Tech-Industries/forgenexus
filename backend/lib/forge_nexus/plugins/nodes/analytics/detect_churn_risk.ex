defmodule ForgeNexus.Plugins.Nodes.Analytics.DetectChurnRisk do
  ...
  def execute(config, _inputs, ctx) do
    ...
    at_risk_users =
      ForgeNexus.Forums.detect_churn_risk_users(inactive_days, min_previous_activity)
  ...
  def schema do
    %{
      ...
      description:
        "Identifies previously active users who are at risk of churning based on inactivity.",
      inputs: [],
      ...
      config_fields: [
        %{
          ...
          type: "number",
          default: 14,
          description: "Days of inactivity to flag a user"
        },
        %{
          name: "min_previous_activity",
          type: "number",
          default: 5,
          description: "Minimum previous posts to qualify as formerly active"
        }
      ]
    }
  end
